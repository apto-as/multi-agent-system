...
[![Version](https://img.shields.io/badge/version-2.4.3-blue)](https://github.com/apto-as/tmws)
...
- **Redis Removed**: Simplified architecture using local in-memory caching only
- **Docker-Only Deployment**: Streamlined installation process
- **Local Rate Limiting**: Efficient in-memory rate limiting without external dependencies
