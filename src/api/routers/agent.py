...
class AgentUpdateRequest(BaseModel):
    ...
    team_memberships: list[str] | None = Field(None, description="Updated team memberships")
    learning_enabled: bool | None = Field(None, description="Updated learning setting")
...
class NamespaceCreateRequest(BaseModel):
    ...
    parent_namespace: str | None = Field(None, description="Parent namespace")
...
async def list_agents(
    ...
    access_level: str | None = Query(None, description="Filter by access level"),
...
async def get_recommended_agents(
    task_type: str | None = Query(None, description="Task type for recommendations"),
    capabilities: list[str] | None = Query(None, description="Required capabilities"),
    namespace: str | None = Query(None, description="Filter by namespace"),
...
async def list_namespaces(
    access_policy: str | None = Query(None, description="Filter by access policy"),
    is_active: bool | None = Query(None, description="Filter by active status"),
    limit: int = Query(50, ge=1, le=100, description="Maximum number of results"),
    offset: int = Query(0, ge=0, description="Offset for pagination"),
    db: AsyncSession = Depends(get_db_session_dependency),
