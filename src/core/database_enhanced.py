...
class DatabaseManager:
    ...
    def __init__(self):
        ...
        self._read_engine: sa.Engine | None = None
        self._write_engine: sa.Engine | None = None
    ...
    async def run_migrations(self, alembic_cfg_path: str | None = None) -> None:
...
async def init_database(primary_url: str | None = None,
                       read_url: str | None = None,
                       workload_type: str = "mixed") -> None:
...
class DatabaseTransaction:
    ...
    def __init__(self, session: Session, isolation_level: str | None = None):
...
class AsyncDatabaseTransaction:
    ...
    def __init__(self, session: AsyncSession, isolation_level: str | None = None):
        self.session = session
        self.isolation_level = isolation_level
        self._savepoint = None
