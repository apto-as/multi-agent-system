...
class FastMCPManager(ServiceManager):
    ...
    async def start(self) -> bool:
        ...
        try:
            logger.info("[TACTICAL] Starting FastMCP service...")
            ...
            while time.time() - start_time < self.config.startup_timeout:
                if await self.health_check():
                    ...
                    logger.info("[TACTICAL] FastMCP service operational")
                    return True
    ...
    async def stop(self) -> bool:
        ...
        try:
            logger.info("[TACTICAL] Stopping FastMCP service...")
            ...
            if self._server_task:
                ...
                try:
                    ...
                    logger.warning("[TACTICAL] FastMCP shutdown timeout")
