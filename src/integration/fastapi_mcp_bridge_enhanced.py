...
from ..mcp_server_v2 import TMWSFastMCPServer
from ..tools import LearningTools, MemoryTools, PersonaTools, SystemTools, TaskTools, WorkflowTools
...
def create_enhanced_bridge_routes(app: FastAPI, bridge: DynamicMCPBridge) -> None:
    ...
    async def get_tool_catalog(module: str | None = None):
