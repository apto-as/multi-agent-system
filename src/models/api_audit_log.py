...
class APIAuditLog(TMWSBase):
    ...
    def set_response_data(self, status: int, body: dict[str, Any] | None = None) -> None:
        """Set response data with validation."""
        self.response_status = status
        if body:
            self.response_body = body

    def set_user_info(self, user_id: str | None = None, ip_addr: str | None = None) -> None:
    ...
    @property
    def response_category(self) -> str | None:
