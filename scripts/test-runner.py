...
class TestRunner:
    ...
    def run_full_suite(self, categories: list[str] = None, extra_args: list[str] = None):
        ...
        print("🏛️  Athena: Harmonious test orchestration")
        print("🏹 Artemis: Technical excellence and performance")
        print("🔥 Hestia: Security and vulnerability testing")
        print("⚔️  Eris: Integration and coordination")
        print("🎭 Hera: Strategic validation and E2E testing")
        print("📚 Muses: Documentation and reporting")
