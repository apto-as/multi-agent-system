...
class TestTokenBudgetServiceIntegration:
    ...
    async def test_free_tier_budget_validation_with_real_db(self, test_session, test_agent):
    ...
    async def test_get_budget_status_with_real_db(self, test_session, test_agent):
    ...
    async def test_token_consumption_persistence(self, test_session, test_agent):
    ...
    async def test_reset_budget_with_real_db(self, test_session, test_agent):
    ...
    async def test_pro_tier_budget_validation(self, test_session, test_agent_pro):
    ...
    async def test_window_hour_format(self, test_session, test_agent):
