...
Trinitasシステムは**9つの専門化されたAIペルソナ**で構成されており、それぞれが特定の領域で卓越した能力を持っています。TMWS (Trinitas Memory & Workflow System) v2.4.18と完全統合されており、42のMCPツールを通じてメモリ管理、ワークフロー調整、セマンティック検索機能を提供します。
...
- **v2.4.18** (2025-12-05): Tool Search + MCP Hub, Adaptive Ranking, Security Hardening
...
*Trinitas Core System v2.4.18 - Unified Intelligence for Claude Code & OpenCode*
*TMWS v2.4.18 - 42 MCP Tools - 9 Specialized Agents*
