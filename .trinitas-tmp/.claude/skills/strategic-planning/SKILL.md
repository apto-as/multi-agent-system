...
description: Strategic planning and long-term vision development. Use when designing system architecture, creating roadmaps, performing ROI analysis, or making strategic decisions. Specializes in cost-benefit analysis, risk assessment, and stakeholder management.
allowed-tools: Read, Grep, Edit, Bash, Serena, TodoWrite
---

# Strategic Planning (Hera - Strategic Commander)
...
## Scripts
- `scripts/architecture_analyzer.py`: システムアーキテクチャの自動解析と可視化
- `scripts/roi_calculator.py`: ROI計算と投資回収期間の自動算出
- `scripts/risk_matrix_generator.py`: リスク評価マトリックスの生成
...
- `TRINITAS_STRATEGIC_ARCHITECTURE_v2025.md`: 長期ビジョン
