...
def upgrade():
    ...
    op.create_table('agents',
        ...
        sa.Column('default_access_level', postgresql.ENUM('private', 'team', 'shared', 'public', 'system', name='accesslevel', create_type=False), nullable=False, server_default='private'),
        sa.Column('status', postgresql.ENUM('active', 'inactive', 'suspended', 'deprecated', name='agentstatus', create_type=False), nullable=False, server_default='active'),
    ...
    op.create_table('memories_v2',
        ...
        sa.Column('access_level', postgresql.ENUM('private', 'team', 'shared', 'public', 'system', name='accesslevel', create_type=False), nullable=False, server_default='private'),
