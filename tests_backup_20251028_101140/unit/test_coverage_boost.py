...
class TestModelUtilities:
    ...
    def test_model_validation(self):
        ...
        # Valid data
        valid_data = {"id": str(uuid.uuid4()), "name": "Valid Model", "status": "active"}
...
class TestSecurityUtilities:
    ...
    def test_input_sanitization(self):
        ...
        def sanitize_html_input(html_string):
            ...
            cleaned = re.sub(
                r"<script.*?</script>", "", html_string, flags=re.IGNORECASE | re.DOTALL
            )
                ...
                if value is not None:
                    if field.endswith("_like"):
                        ...
                        filtered_data = [
                            ...
                            and str(value).lower() in str(item[actual_field]).lower()
                        ]
                        ...
                        filtered_data = [
                            item for item in filtered_data if field in item and item[field] == value
                        ]
